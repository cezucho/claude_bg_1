...
| 6 | ~~**Should the board have impassable terrain?**~~ **RESOLVED 2026-08-17 — no, because the terrain is the other players.** Movement & Targeting rule 4 makes every champion block movement. Measured: a five-champion wall adds 3 hexes of detour and leaves no hex unreachable, so bodies tax movement without creating the corridors rule 3 rejects | — | — | Closed. See `movement-and-targeting.md` |
